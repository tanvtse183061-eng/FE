    ...
    <>
      <div className={`sidebar-card ${isCollapsed ? "collapsed" : ""}`}>
        ...
        <div className="menu">
          ...
          <li onClick={() => navigate("vehicles")} className='truy'><FontAwesomeIcon icon={faCar} /><span>Truy vấn thông tin xe</span></li>
           <li className='quan'><FontAwesomeIcon icon={faFileAlt} /><span>Báo giá</span></li>
           <li onClick={() => navigate("customers")} className='hang'><FontAwesomeIcon icon={faUsers} /><span>Khách hàng</span></li>
